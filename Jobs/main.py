...
def streamWriter(input: DataFrame, checkpointFolder: str, output: str):
    return (input.writeStream
            .format('parquet')
            .option('checkpointLocation', checkpointFolder)  # Fixed capitalization
            .option('path', output)
            .outputMode('append')
...
if __name__ == "__main__":
    ...
    text_input_dir = 'file:///jobs/input/input_text2/'
    json_input_dir = 'file:///jobs/input/input_json2/'
    ...
    checkpoint_path = 's3a://bucket_name/checkpoints/'
    output_path = 's3a://bucket_name/data/spark_unstructured/'

    query = streamWriter(union_dataframe, checkpoint_path, output_path)
